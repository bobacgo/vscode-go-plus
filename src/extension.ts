...
import { WorkspaceNavigator } from './core/navigator/workspace_navigator';  // 导入工作空间导航器模块
...
export function activate(context: vscode.ExtensionContext) {
    ...
    try {
        // 创建状态栏项目 - 使用新模块
        workspaceNavigatorStatusBarItem = WorkspaceNavigator.createStatusBarItem(context);
